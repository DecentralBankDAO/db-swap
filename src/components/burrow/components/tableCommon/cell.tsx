...
import { IReward, UIAsset } from "../../../../interfaces";
import { useSelector } from "react-redux";
import { getDisplayAsTokenValue, getShowDust } from "../../../../redux/slices/Burrow/appSelectors";
...
export const Cell = ({
  ...
  const { price } = rowData;
  const displayAsTokenValue = useSelector(getDisplayAsTokenValue);
  const showDust = useSelector(getShowDust);
